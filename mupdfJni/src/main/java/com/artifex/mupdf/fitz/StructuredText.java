...
public class StructuredText
{
	...
	public synchronized native void walk(StructuredTextWalker walker);
	...
	public class TextBlock {
		...
		public String getString(){
			...
			int i = 0;
			for (TextLine textChar : lines){
				for (TextChar textChar1 : textChar.chars){
					stringBuilder.append((char)textChar1.c);
					i++;
				}
				if(i > 20) break;
//				Log.d("textBox", stringBuilder.toString());
			}
