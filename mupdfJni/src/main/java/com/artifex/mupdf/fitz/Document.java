...
public class Document
{
	...
	public synchronized native Page loadPage(int chapter, int number);
	...
	public synchronized Page loadPage(int number) {
		int start = 0;
		int nc = countChapters();
		for (int i = 0; i < nc; ++i) {
			int np = countPages(i);
	...
	public synchronized Location nextPage(Location loc) {
