...
public class SVG
{
   ...
   public void  renderToCanvas(Canvas canvas,boolean isStroke,float strokeWidth,int strokeColor)
   {
      float strokeWidthReal = strokeWidth*getDocumentWidth()/canvas.getWidth();
      renderToCanvas(canvas, (RenderOptions) null,isStroke,strokeWidthReal,strokeColor);
   }
   ...
   public void  renderToCanvas(Canvas canvas, RenderOptions renderOptions,boolean isStroke,float strokeWidth,int colorStroke)
   {
      base.renderToCanvas(canvas, renderOptions,isStroke,strokeWidth,colorStroke);
   }
